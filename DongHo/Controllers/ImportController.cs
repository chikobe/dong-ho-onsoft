...
namespace DongHo.Controllers
{
    public class ImportController : Controller
    {
        ...
        public ActionResult ImportIndex()
        {
            ...
            #endregion
            var all = data.sp_Import_GetByTop("", str, "").OrderByDescending(m=>m.idate).ToList();
            ...
            if (pages.Count > 0)
            {
                for (int i = 0; i < pages.Count; i++)
                {
                    ...
                    if (i % 2 == 0)
                    {
                        ...
                        {
                            chuoi += "<p class='vdelete' title='Xóa' onclick='AlertErr()'>Xóa</p>";
                        }
                        chuoi += "</td>";
                        chuoi += "</tr>";
                    }
        ...
        public ActionResult ImportCreate()
        {
            ...
            if (Session["AddProductImport"] != null)
            {
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    ...
                    chuoipro += "<td><span class='money'>"+list[i].Price+"</span><input type='hidden' name='hideMoney_" + i + "' id='hideMoney_" + i + "' value='0'/> VNĐ</td>";
                ...
                chuoipro += "<td colspan=\"4\" class=\"trTilte\"><input type='hidden' name='hideTotal' id='hideTotal' value='"+tong+"'/>Tổng tiền</td>";
                chuoipro += "<td colspan=\"2\" class=\"trTotal\"><span id='total'>"+tong+"</span> VNĐ</td>";
                chuoipro += "</tr>";
            }
            chuoipro += "</table>";
